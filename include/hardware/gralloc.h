...
typedef struct gralloc_module_t {
  ...
  int (*lock_ycbcr)(struct gralloc_module_t const *module,
                    ...
                    int h, struct android_ycbcr *ycbcr);
  ...
  int (*lockAsync_ycbcr)(struct gralloc_module_t const *module,
                         buffer_handle_t handle, int usage, int l, int t, int w,
                         int h, struct android_ycbcr *ycbcr, int fenceFd);
   ...
   * the specified width, height, format, usage, and stride. This must at least
   * validate that the buffer size is large enough. Validating the buffer
   * against individual buffer attributes is optional.
   */
  int32_t (*validateBufferSize)(struct gralloc_module_t const *device,
